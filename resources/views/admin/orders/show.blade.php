    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group float-right" style="margin-right: 10px">
                <a href="{{ route('admin.admin.orders.index') }}" class="btn btn-sm btn-default"><i class="fa fa-list"></i> 列表</a>
            </div>
        </div>
    </div>
    <div class="box-body">
        <table class="table table-bordered">
            ...
            @if($order->ship_status === \App\Models\Order::SHIP_STATUS_PENDING)
                ...
                <tr>
                    <td colspan="4">
                        <form action="{{ route('admin.admin.orders.ship', [$order->id]) }}" method="post" class="form-inline">
                            <!-- 别忘了 csrf token 字段 -->
                            {{ csrf_field() }}
        ...
        $('#btn-refund-disagree').click(function() {
            ...
            swal({
                ...
                preConfirm: function(inputValue) {
                    ...
                    return $.ajax({
                        url: '{{ route('admin.admin.orders.handle_refund', [$order->id]) }}',
                        type: 'POST',
